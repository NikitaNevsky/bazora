        ...
        children: [
          ...
          Row(
            children: [
              Stack(
                children: [
                  Image.asset('assets/imagess/macbook.png', width: 54, height: 54, fit: BoxFit.cover),
                  if (!confirm)
                    Positioned(
                      left: 36,
                      top: 0,
          ...
          Row(
            children: [
              ...
              if (!button)
                const Row(
                  children: [
                    Icon(Icons.chat_bubble_outline, color: Color(0xFF232A36)),
                    SizedBox(width: 6),
                    Text('Перейти в чат', style: TextStyle(color: Color(0xFF232A36), fontWeight: FontWeight.bold)),
                  ],
                ),
            ],
          ),
