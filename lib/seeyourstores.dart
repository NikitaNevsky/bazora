...
class SeeYourStores extends StatefulWidget {
  const SeeYourStores({super.key});

  @override
  State<SeeYourStores> createState() => _SeeYourStoresState();
}

class _SeeYourStoresState extends State<SeeYourStores> {
  @override
